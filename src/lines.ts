...
export function getLine() {
	const lines = [
		...
		`What is this thing I see? Is this ${randItem(['true', 'reality', 'a dream', 'fantasy'])}? Can it be? Towards me it cometh, I cannot stop it. But do I want to? I know not. They come as a pair with five pairs within, they come ${randItem(['cloaked', 'wrapped', 'drenched'])} in sin. The ${randItem(['curiosity', 'appeal', 'pull'])} is ${randItem(['strong', 'powerful', 'overwhelming'])}, but I've been here before. I ${randItem(['MUST ', 'WILL ', 'CAN'])}NOT GIVE IN, for I ${randItem(['must ', 'will ', 'can'])}not sin. But "why?" I must ask, the human body is really quite neat, I mean... they're just feet.`,
		`Tip tap, tip tap go the toes, as they move to the ${randItem(['beat', 'rhythm', 'tune', 'melody'])} of the song. The moment is here, don't miss it. Are you listening? The toes can hear but you're too busy scrolling, too busy trolling. ${randItem(['Tap', 'Tip'])}, ${randItem(['tap', 'tip'])}, ${randItem(['tap', 'tip'])} the toes continue, but you're not listening to what they are telling you. GET UP YOU FOOL, it's time to ${randItem(['move', 'rise', 'stand'])}, you're missing the song, you're missing your chance to dance, to live. Do it now or you'll keep on scrolling, scrolling to the end of the feed.`,
		`Where did the feet go I wonder? I look down and see ${randItem(['two', '2'])}, I look out and see ${randItem(['two, four', '2, 4'])}, so many more. The ${randItem(['dogs', 'goats', 'horses'])} trot, the ${randItem(['frogs', 'hares', 'kangaroos'])} hop, but the poor fish cannot. Their feet were ${randItem(['taken', 'stolen', 'fished'])} from them, but what can I do? I wish I could give them my feet, so they could see what it's like. I want them to know how to feel the ${randItem(['ground', 'grass', 'dirt'])} undertow. Alas I must continue ${randItem(['walking', 'running', 'jogging'])}, and the fish, swimming.`,
		...
		`I look behind me and see the ${randItem(['prints', 'impressions', 'outline'])} of ${randItem(['two', '2'])} feet. I look forward and wonder, when will I see ${randItem(['four', '4'])}, when will I see more? ${randItem(['Two', '2'])} is too few, it's no better than ${randItem(['one', '1'])}. Life with ${randItem(['four', '4'])} feet would be so much more fun. I dream of the day when I can look back and see ${randItem(['prints', 'impressions', 'outlines'])} of ${randItem(['four', '4'])} feet, not ${randItem(['two', '2'])}. But I must keep plodding until that ${randItem(['day', 'night'])} comes, until ${randItem(['two', '2'])} other feet join me, if it ever does. The longer the ${randItem(['path', 'road'])} the lesser the hope, and perhaps I will never see ${randItem(['four', '4'])} feet, but I must keep walking, I must keep hoping.`,
		`Look at the ${randItem(['colours', 'pigments', 'hues', 'shades'])}, what a masterpiece. I am an artist, I am the creator of beauty. ${randItem(['Ten', '10'])} canvases for me to paint, oh what opportunity. I wield the brush and stroke, stroke, stroke. The ${randItem(['pigment', 'paint', 'polish'])} flows and the ${randItem(['colours', 'hues', 'shades'])} grow into a thing of beauty, and what a thing to behold. Behold, my magnum opus is complete, painted on these ${randItem(['two', '2'])} feet. I did that, I am an artist. I did that, I am an artist. I am an artist.`,
