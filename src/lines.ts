...
export function getLine() {
	const lines = [
		...
		`Waning moon I'll see you soon. The man, the man he calls me. A treat, a treat he has for me. Down below, behind the toe, a taste of something sweet. A taste of something sour. The clock strikes the hour. Ding dong ding, the time has come to taste the feet. With sweat upon my brow I can smell them now, I can feel them now. Heaven strikes my tounge, I feel as if I'm young once more. Life is now an open door. The man, the man, he calls me`,
