...
export function getLine() {
	const lines = [
		...
		`I look at feet. It is a treat. How the wriggle, flex, and bend. And when I close my eyes to sleep, I dream of them again. Each ridge of print, each callous and glint of nail is so refined. The perfection of its curve and shape can only be divine.`
